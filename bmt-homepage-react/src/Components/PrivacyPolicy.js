...
function Privacy() {
	useEffect(() => {
		document.title = "BMT Micro - Privacy Policy"
	})
	return (
			...
			<Container className="privacy">
				<Row className="justify-content-center">
					<Col>
						...
						<h5 style={{ color: '#000000' }}>What information does BMT collect? How do we use it?</h5>
						<p>
						...
						<p>
							We may also collect and store, for a limited time and for the purpose of serving our customers, e.g. correspondence sent to us regarding orders or ordering, as well as requested authentication (such as proof of ID to verify an order, if the order information is inconsistent or indicates potential fraud). We do not share any customer information, other than as required by law or as required to fill the order and perform our services. Customer information such as name, address, telephone number, and email may be shared with software suppliers (our “vendors”) in relation to the sale of the supplied product through BMT Micro. We do not permit our software suppliers to share customer information with any other party, or use this information for any other purpose than to fill the order and/or to provide assistance to customers e.g. in matters of technical support. Our suppliers are required to adhere to the same high privacy standards as BMT Micro or their accounts with us will be terminated. Every BMT Micro customer is given access to a BMT Micro customer account. The information in such accounts is limited to customer name, email, and order history. Every account is secured through technological encryption barriers and behind individual passwords and logins, which the customers themselves can modify at their discretion. Any and all BMT Micro customer accounts can and will be deleted upon customer request. Such requests can be made to <a href="mailto:webmaster@bmtmicro.com">webmaster@bmtmicro.com</a>.
						</p>
						<p>
						...
						<h5 style={{ color: '#000000' }}>How does BMT Micro, Inc. protect customer information?</h5>
						<p>
						...
						<Image
							src="https://www.bmtmicro.com/images/firewall-min.jpg"
							alt="Firewall image"
						...
						<Image
							src="https://www.bmtmicro.com/images/ssl-security-plan-min.jpg"
						...
						<Image
							src="https://www.bmtmicro.com/images/security-metrics-logo-min.jpg"
						...
						<p>
							<strong>EU GDPR (General Data Protection Regulation) and Brazilian LGPD (Lei Geral de Proteção de Dados Pessoais)</strong>
						</p>
						<p>
						...
						<p style={{ textTransform: 'capatilize' }}>
						...
						<p>
							Customers can obtain records of their purchase history or personal data, as collected for the above mentioned purposes of processing an order or software purchase initiated by the customer, e.g. by logging into their BMT Micro customer account at <a href="https://customers.bmtmicro.com/">https://customers.bmtmicro.com</a> or by making a written request to <a href="mailto:webmaster@bmtmicro.com">webmaster@bmtmicro.com</a>. Customer records will not be released unless the identity of the requester can be positively confirmed.
						</p>
						<p>
						...
						<p>
							For more information on how BMT Micro protects your privacy, please do not hesitate to contact <a href="mailto:cservice@bmtmicro.com">cservice@bmtmicro.com</a> or <a href="mailto:webmaster@bmtmicro.com">webmaster@bmtmicro.com</a>.
						</p>
						<p>
