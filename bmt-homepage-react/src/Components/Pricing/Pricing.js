  ...
  return (
    <div className="body-content">
      ...
      <Container className="pricing">
        <h5 className="text-center black-text">At BMT Micro, we believe in doing what is best for our vendors and can custom tailor a plan that works best for you!</h5>
        <Row>
          <BasicTier />
          <AdvancedTier />
        </Row>
