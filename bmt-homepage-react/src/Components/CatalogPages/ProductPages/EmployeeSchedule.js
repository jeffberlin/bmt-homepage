      ...
      <Container className="catalog">
        ...
        <Row className="justify-content-center">
          <Col xl={10} lg={10} md={10} sm={10}>
            ...
            <p><a href="http://www.satxusasoftware.com/employee_schedule.html" className="catalog-link">Visit Site</a></p>
        ...
        <Row className="justify-content-center info-section">
          ...
          <Col xl={{ span: 4, order: 1 }} lg={{ span: 4, order: 1 }} md={{ span: 6, order: 1 }} sm={{ span: 6, order: 1 }} xs={{ span: 12, order: 2 }}>
            <div className="product-image text-left">
              <Image
                src="https://bmtmicro.com/bmtcatalog/images/employee-schedule-screenshot1-min.jpg"
                fluid
              />
            </div>
          </Col>
        ...
        <Row className="justify-content-center info-section">
          ...
          <Col xl={4} lg={4} md={6} sm={6} xs={12}>
            <div className="product-image">
              <Image
                fluid
                src="https://bmtmicro.com/bmtcatalog/images/employee-schedule-screenshot2-min.jpg"
              />
            </div>
          </Col>
        </Row>
        <Row className="justify-content-center info-section">
          <Col xl={{ span: 4, order: 1 }} lg={{ span: 4, order: 1 }} md={{ span: 6, order: 1 }} sm={{ span: 6, order: 1 }} xs={{ span: 12, order: 2 }}>
            <div className="product-image text-left">
              <Image
                fluid
                src="https://bmtmicro.com/bmtcatalog/images/employee-schedule-screenshot4-min.jpg"
              />
            </div>
          </Col>
        ...
        <Row className="justify-content-center">
          ...
          <Col xl={8} lg={8} md={8} sm={12} xs={12}>
            <div className="product-image">
              <Image
                fluid
                src="https://bmtmicro.com/bmtcatalog/images/employee-schedule-screenshot3-min.jpg"
              />
            </div>
          </Col>
        </Row>
