    ...
    <Row className="justify-content-center">
      <Col xl={10} lg={10} md={12} sm={12} style={colBorder}>
        ...
        <Image
          ...
          src="images/bmt-micro-solsuite-dial-min.jpg"
          style={productImage}
        />
        <Image
          className="featured-product-image"
          src="images/bmt-micro-solsuite-pyramid-min.jpg"
        ...
        <p className="text-center"><a href="https://www.solsuite.com" target="_blank" rel="noreferrer">Visit Website</a></p>
      </Col>
      <Col xl={10} lg={10} md={12} sm={12} style={colBorder}>
        <h5 className="featured-product-title">Midnight Synergy Games</h5>
        <Image
          className="featured-product-image"
          src="images/bmt-micro-midnight-synergy-dvd-min.jpg"
          style={productImage}
        />
        <Image
          className="featured-product-image"
          src="images/bmt-micro-midnight-synergy-min.jpg"
          style={{ marginBottom: '1rem', width: 170 }}
        />
        ...
        <p className="text-center"><a href="http://midnightsynergy.com/index.html" target="_blank" rel="noreferrer">Visit Website</a></p>
      </Col>
      <Col xl={10} lg={10} md={12} sm={12} style={colBorder}>
        <h5 className="featured-product-title">FeelThere</h5>
        <Image
          className="featured-product-image"
          src="images/bmt-micro-feelthere-1-min.jpg"
          style={productImage}
        />
        <Image
          className="featured-product-image"
          src="images/bmt-micro-feelthere-2-min.jpg"
          style={{ marginBottom: '1rem', width: 170 }}
        />
        ...
        <p className="text-center"><a href="https://www.feelthere.com/" target="_blank" rel="noreferrer">Visit Website</a></p>
      </Col>
      <Col xl={10} lg={10} md={12} sm={12} style={colBorder}>
        <h5 className="featured-product-title">Democracy 3</h5>
        <Image
          className="featured-product-image"
          src="images/bmt-micro-democracy3-1-min.jpg"
          style={productImage}
        />
        <Image
          className="featured-product-image"
          src="images/bmt-micro-democracy3-2-min.jpg"
          style={{ marginBottom: '1rem', width: 170 }}
        />
        ...
        <p className="text-center"><a href="http://positech.co.uk/democracy3/" target="_blank" rel="noreferrer">Visit Website</a></p>
      </Col>
      <Col xl={10} lg={10} md={12} sm={12} style={colBorder}>
        <h5 className="featured-product-title">PMView Pro 3.81</h5>
        <Image
          className="featured-product-image"
          src="images/bmt-micro-pmview-1-min.jpg"
          style={productImage}
        />
        <Image
          className="featured-product-image"
          src="images/bmt-micro-pmview-2-min.jpg"
        ...
        <p className="text-center"><a href="http://www.pmview.com/" target="_blank" rel="noreferrer">Visit Website</a></p>
      </Col>
      <Col xl={10} lg={10} md={12} sm={12}>
        <h5 className="featured-product-title">Project Dogwaffle</h5>
        <Image
          className="featured-product-image"
          src="images/bmt-micro-project-dogwaffle-1-min.jpg"
          style={productImage}
        />
        <Image
          className="featured-product-image"
          src="images/bmt-micro-project-dogwaffle-2-min.jpg"
          style={{ marginBottom: '1rem', width: 170 }}
        />
        ...
        <p className="text-center"><a href="https://www.thebest3d.com/index.html" target="_blank" rel="noreferrer">Visit Website</a></p>
      </Col>
    </Row>
  );
}
