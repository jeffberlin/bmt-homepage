...
import FileCommanderWinModal from './FileCommanderWinModal';

function FileCommanderWin() {
  useEffect(() => {
    document.title = "BMT Micro Catalog - File Commander for Win95/NT"
  })
  const [modalShow, FileCommanderWinModalShow] = useState(false);
  return (
      ...
      <Container className="catalog">
        ...
        <Row className="justify-content-center">
          <Col xl={10} lg={10} md={10} sm={10}>
            <h2>File Commander for Win95/NT</h2>
            <p><a href="http://silk.apana.org.au/fc.html" className="catalog-link" rel="noreferrer">Visit Site</a></p>
            <p className="info-section">File Commander is a 32 bit text mode file manager and shell that allows you to locate, copy, move, delete, view, edit and execute your files in a quick, convenient and customizable manner.</p>
          </Col>
        </Row>
        <Row className="justify-content-center info-section">
          ...
          <Col xl={4} lg={4} md={6} sm={6} xs={12}>
            ...
            <button className="demo-btn" onClick={() => FileCommanderWinModalShow(true)}>Download Demo</button>
            <FileCommanderWinModal
              show={modalShow}
              onHide={() => FileCommanderWinModalShow(false)}
            />
          </Col>
        </Row>
        ...
        <Row className="justify-content-center info-section">
          ...
          <Col xl={4} lg={4} md={6} sm={6} xs={12}>
            <ul style={{ listStyleType: 'circle', paddingLeft: '15px' }}>
              ...
              <li><p>Colourization of file and directory names by boolean expression</p></li>
...
export default FileCommanderWin;
