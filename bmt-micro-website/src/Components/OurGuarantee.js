      ...
      <Container className="affiliates">
        <Row className="justify-content-center">
          <Col xl={12} lg={12} md={12} sm={12} style={{ marginBottom: '2rem' }}>
            ...
            <p>
              Products or services obtained through the additional company BMT Micro Finland is subject to these same terms and conditions and covered under the same BMT Micro guarantee.
            </p>
          </Col>
        </Row>
      </Container>
